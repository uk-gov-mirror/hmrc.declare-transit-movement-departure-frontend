...
class AddItemsNavigatorSpec extends SpecBase with ScalaCheckPropertyChecks with Generators {
  ...
  "Add Items section" - {
    ...
    "in normal mode" - {
      ...
      "must go from CommodityCodePage to Do you know the consignor eori page when Consignor and Consignee is not the same for all items" in {
      ...
      "must go from CommodityCodePage to Do you know the consignee eori page when Consignor is the same but Consignee is not for all items" in {
      ...
      "must go from CommodityCodePage to Do you know the consignee eori page when there is a Consignor for all but Consignee is not for all items" in {
      ...
      "must go from CommodityCodePage to CYA page when there is a Consignor for all and Consignee is the same for all items" in {
      ...
      "must go from CommodityCodePage to CYA page when Consignor and Consignee is the same for all items" in {
      ...
      "must go from CommodityCodePage to Session Expired when there are no answers in Header Trader Details" in {
