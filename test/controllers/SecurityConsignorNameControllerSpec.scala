...
class SecurityConsignorNameControllerSpec extends SpecBase with MockNunjucksRendererApp with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  lazy val securityConsignorNameRoute = routes.SecurityConsignorNameController.onPageLoad(lrn, NormalMode).url
  ...
  "SecurityConsignorName Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set(SecurityConsignorNamePage, "answer").success.value
