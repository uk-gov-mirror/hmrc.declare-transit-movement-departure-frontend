...
class SecurityConsignorAddressControllerSpec extends SpecBase with MockNunjucksRendererApp with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  lazy val securityConsignorAddressRoute = routes.SecurityConsignorAddressController.onPageLoad(lrn, NormalMode).url
  ...
  "SecurityConsignorAddress Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set(SecurityConsignorAddressPage, "answer").success.value
