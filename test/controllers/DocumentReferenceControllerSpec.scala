...
import forms.DocumentReferenceFormProvider
...
import pages.DocumentReferencePage
...
class DocumentReferenceControllerSpec extends SpecBase with MockNunjucksRendererApp with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  private val template     = "documentReference.njk"
  ...
  "DocumentReference Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set(DocumentReferencePage, "answer").success.value
