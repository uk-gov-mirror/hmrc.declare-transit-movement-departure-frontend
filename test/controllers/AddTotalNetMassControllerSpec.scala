...
class AddTotalNetMassControllerSpec extends SpecBase with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  lazy val addTotalNetMassRoute = routes.AddTotalNetMassController.onPageLoad(lrn, NormalMode).url
  ...
  "AddTotalNetMass Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers    = UserAnswers(lrn, eoriNumber).set(AddTotalNetMassPage, true).success.value
