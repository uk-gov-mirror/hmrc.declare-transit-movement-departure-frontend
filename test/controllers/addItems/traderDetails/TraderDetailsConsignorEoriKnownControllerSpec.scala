...
class TraderDetailsConsignorEoriKnownControllerSpec extends SpecBase with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  "TraderDetailsConsignorEoriKnown Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers    = UserAnswers(lrn, eoriNumber).set(TraderDetailsConsignorEoriKnownPage(index), true).success.value
