...
class TraderDetailsConsigneeEoriNumberControllerSpec extends SpecBase with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  "TraderDetailsConsigneeEoriNumber Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers    = emptyUserAnswers.set(TraderDetailsConsigneeEoriNumberPage(index), "answer").success.value
