...
import forms.addItems.securityDetails.UsingSameCommercialReferenceFormProvider
...
class UsingSameCommercialReferenceControllerSpec extends SpecBase with MockNunjucksRendererApp with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  "UsingSameCommercialReference Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      val request        = FakeRequest(GET, usingSameCommercialReferenceRoute)
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(lrn, eoriNumber).set(UsingSameCommercialReferencePage(index), true).success.value
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      val request =
        FakeRequest(POST, usingSameCommercialReferenceRoute)
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      val request        = FakeRequest(POST, usingSameCommercialReferenceRoute).withFormUrlEncodedBody(("value", ""))
