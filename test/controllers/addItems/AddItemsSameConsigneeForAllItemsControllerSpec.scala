...
class AddItemsSameConsigneeForAllItemsControllerSpec extends SpecBase with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  "AddItemsSameConsigneeForAllItems Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers    = UserAnswers(lrn, eoriNumber).set(AddItemsSameConsigneeForAllItemsPage(index), true).success.value
