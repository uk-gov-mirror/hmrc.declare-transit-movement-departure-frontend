...
import forms.guaranteeDetails.DefaultAmountFormProvider
...
import pages.guaranteeDetails.DefaultAmountPage
...
class DefaultAmountControllerSpec extends SpecBase with MockNunjucksRendererApp with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  "DefaultAmount Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      val userAnswers = emptyUserAnswers.set(DefaultAmountPage, true).success.value
