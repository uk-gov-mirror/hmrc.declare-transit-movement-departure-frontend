...
class ConfirmRemoveOfficeOfTransitControllerSpec extends SpecBase with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  lazy val confirmRemoveOfficeOfTransitRoute = routes.ConfirmRemoveOfficeOfTransitController.onPageLoad(lrn, NormalMode).url
  ...
  "ConfirmRemoveOfficeOfTransit Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(lrn, eoriNumber).set(ConfirmRemoveOfficeOfTransitPage, true).success.value
