...
object TraderDetailsSpec extends UserAnswersSpecHelper {
  ...
  def setTraderDetails(traderDetails: TraderDetails)(startUserAnswers: UserAnswers): UserAnswers =
    startUserAnswers
      ...
      // Set Consignor
      .unsafeSetVal(ConsignorForAllItemsPage)(traderDetails.consignor.isDefined) // TODO Need to account for this in reader (AddConsignorPage etc wont be asked)
      ...
      // Set Consignee
      .unsafeSetVal(ConsigneeForAllItemsPage)(traderDetails.consignee.isDefined) // TODO Need to account for this in reader (AddConsigneePage etc wont be asked)
