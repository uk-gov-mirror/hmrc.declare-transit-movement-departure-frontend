      ...
      Row(
        ...
        actions = List(
          Action(
            ...
            href               = routes.AddAnotherPackageController.onPageLoad(lrn, CheckMode).url,
            visuallyHiddenText = Some(msg"site.edit.hidden".withArgs(msg"addAnotherPackage.checkYourAnswersLabel"))
          )
        )
      )
  }
